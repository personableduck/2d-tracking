function tracksFinal = uTrack(movieInfo,GapWindow,mergeSplit,linearMotion,minSearchRadius,maxSearchRadius,path_save)
%This file is tracking part of u-track.
%
...
gapCloseParam.timeWindow = GapWindow;

%Flag for merging and splitting
gapCloseParam.mergeSplit = mergeSplit;
...
parameters.linearMotion = linearMotion;
...
%saveResults
saveResults.dir = path_save; %directory where to save input and output
saveResults.filename = 'uTracking.mat'; %name of file where input and output are saved
